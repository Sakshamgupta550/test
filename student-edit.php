...
{
$sname=mysqli_real_escape_string(trim($_POST['sname']));
$fname=mysqli_real_escape_string(trim($_POST['fname']));
$dob=$_POST['dob'];
$ed_level=$_POST['ed_level'];
$branch=$_POST['branch'];
$batch=$_POST['batch'];
$phone1=mysqli_real_escape_string(trim($_POST['phone1']));
$phone2=mysqli_real_escape_string(trim($_POST['phone2']));
if($phone2=="")
{
$op_no="Nill";
}
...
$m_name=mysqli_real_escape_string(trim($_POST['mname']));
if($m_name=="")
{
$mname="Not Provided";
}
...
$t_caste=mysqli_real_escape_string(trim($_POST['caste']));
if($t_caste=="")
{
$caste="Not Provided";
}
...
$t_subcaste=mysqli_real_escape_string(trim($_POST['subcaste']));
if($t_subcaste=="")
{
...
$t_adar=mysqli_real_escape_string(trim($_POST['adar']));
if($t_adar=="")
{
$adar="Not Provided";
}
